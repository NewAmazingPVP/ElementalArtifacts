...
public class AutoUpload {
    ...
    public static void startReleaseChecker() {
        ...
        }.runTaskTimerAsynchronously(elementalArtifacts, 0L, 300L);
    }
    ...
    private static void loadApiKey() {
        try {
            ...
            if (!file.exists()) {
                elementalArtifacts.getLogger().info("api.yml file not found. Please create the file and add your API key.");
                return;
            }
            ...
            elementalArtifacts.getLogger().info("Failed to load api.yml file: " + e.getMessage());
        }
    }
    ...
    private static void checkForNewRelease() {
        try {
            ...
            elementalArtifacts.getLogger().info("Failed to check for new releases: " + e.getMessage());
        }
    }
